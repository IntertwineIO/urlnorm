...
def pytest_generate_tests(metafunc):
    if metafunc.function in [test_norms]:
        ...
        tests = {
            ...
            # empty port
            'http://www.thedraymin.co.uk:/main/?p=308': 'http://www.thedraymin.co.uk/main/?p=308',
            ...
            # should not un-encode the & that is part of a parameter value
            'http://test.example/?a=%26&b=1': 'http://test.example/?a=%26&b=1',
            # should return a unicode character
            'http://test.example/?a=%e3%82%82%26': 'http://test.example/?a=\xe3\x82\x82%26'.decode('utf8'),
            ...
            # u'http://xn--q-bga.XBLA\u306eXbox.com'.encode('utf8'):
            # 'http://q\xc3\xa9.xbla\xe3\x81\xaexbox.com'.decode('utf8'),
            ...
            "http://test.example/path;par%20ams/with a%20space+/": "http://test.example/path;par ams/with a space+/",
            # ipv6 address
            "http://[2001:db8:1f70::999:de8:7648:6e8]/test": "http://[2001:db8:1f70::999:de8:7648:6e8]/test",
            ...
            "htTps://[::fFff:192.168.1.1]:443/test": "https://[::ffff:192.168.1.1]/test",
